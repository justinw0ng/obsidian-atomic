...
export const en = {
  ...
  "view.dashboard.openCues": "Open {activity} cues →",
  ...
  "view.dashboard.avgPerSession": "{minutes} min · avg {avg} min / session",
  "view.dashboard.setTableRows": "Set-table rows",
  "view.dashboard.activities": "Activities",
  "view.dashboard.activitiesMeta": "Enabled habits only · colors from Settings",
  ...
  "view.dashboard.barsSessions": "Sessions per month",
  "view.dashboard.barsMinutes": "Timer minutes per month",
  "view.dashboard.lastSession": "last: {date}",
  ...
  "view.dashboard.byVolumeSets": "by volume · sets",
  ...
  "view.dashboard.recentMeta": "Latest {count} · click to open the note",
