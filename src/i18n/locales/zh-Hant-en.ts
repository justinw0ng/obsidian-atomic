...
export const zhHantEn = {
  ...
  "view.dashboard.openCues": "Open {activity} cues / 提醒彙整 →",
  ...
  "view.dashboard.hourUnit": "h",
  "view.dashboard.minuteUnit": "m",
  ...
  "view.dashboard.barsSessions": "Sessions per month / 每月次數",
  "view.dashboard.barsMinutes": "Timer minutes per month / 每月分鐘",
  "view.dashboard.lastSession": "last / 最近: {date}",
