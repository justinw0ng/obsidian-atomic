...
activity: gym, golf, reading  # all, one id, or comma list (gym, golf). Default: all enabled habits
rows: 2  # preferred rows for several heatmaps. Default: 1
columns: 2  # max columns; 1 stacks vertically. Default: 1
