...
- Cue log (`atomic-cue-log`): type a cue on a session note and click Add cue instead of writing the bullet yourself
- Cue pages (`atomic-cues`, `atomic-golf-cues`, `atomic-gym-cues`): every cue of the year as an index card in a fanned stack; hover or tap pops one out and shows the whole cue
